...
func (v *BaseLMLVisitor) VisitTmplHtmlCss(ctx *TmplHtmlCssContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseLMLVisitor) VisitTmplPdfCss(ctx *TmplPdfCssContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseLMLVisitor) VisitTmplTitle(ctx *TmplTitleContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseLMLVisitor) VisitSwitchBlock(ctx *SwitchBlockContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseLMLVisitor) VisitSwitchBlockStatementGroup(ctx *SwitchBlockStatementGroupContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseLMLVisitor) VisitLdpInt(ctx *LdpIntContext) interface{} {
	return v.VisitChildren(ctx)
}
