...
var rootCmd = &cobra.Command{
	Use:   "neo",
	Short: "Tools for synchronizing neo4j with AGES and doxa sqlite",
	Long: `neo provides commands you can use to keep the OLW neo4j database
up-to-date with changes in AGES Github (the ares files) and to serialize the OLW database.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

neo is a CLI library written in the Go programming language.

This tool was created by staff and volunteers of the 
Orthodox Christian Mission Center (OCMC).

It is available as open source, but is primarily for internal use by OCMC.
