...
var pullCmd = &cobra.Command{
	Use:   "pull",
	Short: "pulls the github repos listed in the config file",
	Long: `pulls the github repositories listed in the config file
...
func init() {
	...
	pullCmd.Flags().StringP("repo", "r", "site", "type of repositories to process, e.g. ares, site.")
}
